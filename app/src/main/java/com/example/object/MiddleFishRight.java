...
public class MiddleFishRight extends EnemyFish{
    ...
    protected void initBitmap() {
        middleFish = BitmapFactory.decodeResource(resources, R.drawable.middlefishright);
